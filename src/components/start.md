The Griffin Chart Builder is a no-code way to build digital-first charts using the [Highcharts charting library][1]. For more information and instructions, please see [the documentation (TK)][2].
